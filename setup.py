...
build_exe_options = {
    ...
    'include_files': [
        ...
        ('npu.exe', 'npu.exe'),  # Newline's Program Updater application
...
class BuildADSM(build_exe):
    def run(self):
        ...
        for file in files:
            if file not in ['ADSM.exe', 'library.zip', 'python34.dll', 'MSVCR100.dll', 'npu.exe']:  # TODO: This line is ADSM specific
