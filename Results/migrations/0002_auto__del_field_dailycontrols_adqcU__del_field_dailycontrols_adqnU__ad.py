...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('Results_dailycontrols', 'adqcU')

        # Deleting field 'DailyControls.adqnU'
        db.delete_column('Results_dailycontrols', 'adqnU')

        # Adding field 'DailyControls.adqnUAll'
        db.add_column('Results_dailycontrols', 'adqnUAll',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'DailyControls.adqcUAll'
        db.add_column('Results_dailycontrols', 'adqcUAll',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.add_column('Results_dailycontrols', 'adqcU',
                      self.gf('django.db.models.fields.IntegerField')(blank=True, null=True),
                      keep_default=False)

        # Adding field 'DailyControls.adqnU'
        db.add_column('Results_dailycontrols', 'adqnU',
                      self.gf('django.db.models.fields.IntegerField')(blank=True, null=True),
                      keep_default=False)

        # Deleting field 'DailyControls.adqnUAll'
        db.delete_column('Results_dailycontrols', 'adqnUAll')

        # Deleting field 'DailyControls.adqcUAll'
        db.delete_column('Results_dailycontrols', 'adqcUAll')
    ...
    models = {
        'Results.dailybyproductiontype': {
            ...
            'descA': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'+'", 'null': 'True', 'to': "orm['Results.DestructionGroup']"}),
            'descU': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'+'", 'null': 'True', 'to': "orm['Results.DestructionGroup']"}),
            'desw': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'+'", 'null': 'True', 'to': "orm['Results.WaitGroup']"}),
            'det': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'+'", 'null': 'True', 'to': "orm['Results.DetectionGroup']"}),
            'exm': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'+'", 'null': 'True', 'to': "orm['Results.TestTriggerGroup']"}),
            'exp': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'+'", 'null': 'True', 'to': "orm['Results.SpreadGroup']"}),
            'firstDestruction': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'+'", 'null': 'True', 'to': "orm['Results.DestructionGroup']"}),
            'firstDetection': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'+'", 'null': 'True', 'to': "orm['Results.DetectionBracketGroup']"}),
            ...
            'inf': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'+'", 'null': 'True', 'to': "orm['Results.SpreadGroup']"}),
            'iteration': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            'lastDetection': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'+'", 'null': 'True', 'to': "orm['Results.DetectionBracketGroup']"}),
            'production_type': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['ScenarioCreator.ProductionType']"}),
            'tr': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'+'", 'null': 'True', 'to': "orm['Results.TraceGroup']"}),
            'tsd': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'+'", 'null': 'True', 'to': "orm['Results.StateGroup']"}),
            'tst': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'+'", 'null': 'True', 'to': "orm['Results.TestOutcomeGroup']"}),
            'tstc': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'+'", 'null': 'True', 'to': "orm['Results.TestTriggerGroup']"}),
            'vac': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'+'", 'null': 'True', 'to': "orm['Results.VaccinationGroup']"}),
            'vacw': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'+'", 'null': 'True', 'to': "orm['Results.WaitGroup']"})
        },
        'Results.dailybyzone': {
