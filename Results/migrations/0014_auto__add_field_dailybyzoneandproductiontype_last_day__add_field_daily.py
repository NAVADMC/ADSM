...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DailyByZoneAndProductionType.last_day'
        db.add_column(u'Results_dailybyzoneandproductiontype', 'last_day',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'DailyByProductionType.last_day'
        db.add_column(u'Results_dailybyproductiontype', 'last_day',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'DailyByZone.last_day'
        db.add_column(u'Results_dailybyzone', 'last_day',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'DailyControls.last_day'
        db.add_column(u'Results_dailycontrols', 'last_day',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'DailyByZoneAndProductionType.last_day'
        db.delete_column(u'Results_dailybyzoneandproductiontype', 'last_day')

        # Deleting field 'DailyByProductionType.last_day'
        db.delete_column(u'Results_dailybyproductiontype', 'last_day')

        # Deleting field 'DailyByZone.last_day'
        db.delete_column(u'Results_dailybyzone', 'last_day')

        # Deleting field 'DailyControls.last_day'
        db.delete_column(u'Results_dailycontrols', 'last_day')
