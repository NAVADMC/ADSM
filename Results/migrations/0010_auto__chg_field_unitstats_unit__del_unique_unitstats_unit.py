...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_unique('Results_unitstats', ['unit_id'])


        # Changing field 'UnitStats.unit'
        db.alter_column('Results_unitstats', 'unit_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['ScenarioCreator.Unit']))

    def backwards(self, orm):

        # Changing field 'UnitStats.unit'
        db.alter_column('Results_unitstats', 'unit_id', self.gf('django.db.models.fields.related.OneToOneField')(unique=True, to=orm['ScenarioCreator.Unit']))
        # Adding unique constraint on 'UnitStats', fields ['unit']
        db.create_unique('Results_unitstats', ['unit_id'])
    ...
    models = {
        'Results.dailybyproductiontype': {
            ...
            'production_type': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'to': "orm['ScenarioCreator.ProductionType']", 'null': 'True'}),
            ...
            'tstnUAll': ('django.db.models.fields.IntegerField', [], {'blank': 'True', 'null': 'True'}),
        ...
        'Results.dailybyzone': {
            ...
            'zone': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'to': "orm['ScenarioCreator.Zone']", 'null': 'True'}),
