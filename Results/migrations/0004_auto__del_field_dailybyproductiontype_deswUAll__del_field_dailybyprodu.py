...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'DailyByProductionType.deswUAll'
        db.delete_column('Results_dailybyproductiontype', 'deswUAll')

        # Deleting field 'DailyByProductionType.deswAMaxDay'
        db.delete_column('Results_dailybyproductiontype', 'deswAMaxDay')

        # Deleting field 'DailyByProductionType.deswUDaysInQueue'
        db.delete_column('Results_dailybyproductiontype', 'deswUDaysInQueue')

        # Deleting field 'DailyByProductionType.deswUTimeMax'
        db.delete_column('Results_dailybyproductiontype', 'deswUTimeMax')

        # Deleting field 'DailyByProductionType.deswAAll'
        db.delete_column('Results_dailybyproductiontype', 'deswAAll')

        # Deleting field 'DailyByProductionType.deswUMaxDay'
        db.delete_column('Results_dailybyproductiontype', 'deswUMaxDay')

        # Deleting field 'DailyByProductionType.deswATimeMax'
        db.delete_column('Results_dailybyproductiontype', 'deswATimeMax')

        # Deleting field 'DailyByProductionType.deswUMax'
        db.delete_column('Results_dailybyproductiontype', 'deswUMax')

        # Deleting field 'DailyByProductionType.deswATimeAvg'
        db.delete_column('Results_dailybyproductiontype', 'deswATimeAvg')

        # Deleting field 'DailyByProductionType.deswAMax'
        db.delete_column('Results_dailybyproductiontype', 'deswAMax')

        # Deleting field 'DailyByProductionType.deswUTimeAvg'
        db.delete_column('Results_dailybyproductiontype', 'deswUTimeAvg')

        # Deleting field 'DailyByProductionType.deswADaysInQueue'
        db.delete_column('Results_dailybyproductiontype', 'deswADaysInQueue')

        # Adding field 'DailyByProductionType.deswU'
        db.add_column('Results_dailybyproductiontype', 'deswU',
                      self.gf('django.db.models.fields.IntegerField')(blank=True, null=True),
                      keep_default=False)

        # Adding field 'DailyByProductionType.deswA'
        db.add_column('Results_dailybyproductiontype', 'deswA',
                      self.gf('django.db.models.fields.IntegerField')(blank=True, null=True),
                      keep_default=False)

        # Adding field 'DailyControls.deswATimeMax'
        db.add_column('Results_dailycontrols', 'deswATimeMax',
                      self.gf('django.db.models.fields.IntegerField')(blank=True, null=True),
                      keep_default=False)

        # Adding field 'DailyControls.deswATimeAvg'
        db.add_column('Results_dailycontrols', 'deswATimeAvg',
                      self.gf('django.db.models.fields.IntegerField')(blank=True, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'DailyByProductionType.deswUAll'
        db.add_column('Results_dailybyproductiontype', 'deswUAll',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'DailyByProductionType.deswAMaxDay'
        db.add_column('Results_dailybyproductiontype', 'deswAMaxDay',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'DailyByProductionType.deswUDaysInQueue'
        db.add_column('Results_dailybyproductiontype', 'deswUDaysInQueue',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'DailyByProductionType.deswUTimeMax'
        db.add_column('Results_dailybyproductiontype', 'deswUTimeMax',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'DailyByProductionType.deswAAll'
        db.add_column('Results_dailybyproductiontype', 'deswAAll',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'DailyByProductionType.deswUMaxDay'
        db.add_column('Results_dailybyproductiontype', 'deswUMaxDay',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'DailyByProductionType.deswATimeMax'
        db.add_column('Results_dailybyproductiontype', 'deswATimeMax',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'DailyByProductionType.deswUMax'
        db.add_column('Results_dailybyproductiontype', 'deswUMax',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'DailyByProductionType.deswATimeAvg'
        db.add_column('Results_dailybyproductiontype', 'deswATimeAvg',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'DailyByProductionType.deswAMax'
        db.add_column('Results_dailybyproductiontype', 'deswAMax',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'DailyByProductionType.deswUTimeAvg'
        db.add_column('Results_dailybyproductiontype', 'deswUTimeAvg',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'DailyByProductionType.deswADaysInQueue'
        db.add_column('Results_dailybyproductiontype', 'deswADaysInQueue',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Deleting field 'DailyByProductionType.deswU'
        db.delete_column('Results_dailybyproductiontype', 'deswU')

        # Deleting field 'DailyByProductionType.deswA'
        db.delete_column('Results_dailybyproductiontype', 'deswA')

        # Deleting field 'DailyControls.deswATimeMax'
        db.delete_column('Results_dailycontrols', 'deswATimeMax')

        # Deleting field 'DailyControls.deswATimeAvg'
        db.delete_column('Results_dailycontrols', 'deswATimeAvg')
