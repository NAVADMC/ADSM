...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'DailyControls.vaccSetup'
        db.alter_column('Results_dailycontrols', 'vaccSetup', self.gf('django.db.models.fields.FloatField')(null=True))

        # Changing field 'DailyControls.vaccSubtotal'
        db.alter_column('Results_dailycontrols', 'vaccSubtotal', self.gf('django.db.models.fields.FloatField')(null=True))

        # Changing field 'DailyControls.vaccVaccination'
        db.alter_column('Results_dailycontrols', 'vaccVaccination', self.gf('django.db.models.fields.FloatField')(null=True))

        # Changing field 'DailyControls.destrIndemnification'
        db.alter_column('Results_dailycontrols', 'destrIndemnification', self.gf('django.db.models.fields.FloatField')(null=True))

        # Changing field 'DailyControls.costsTotal'
        db.alter_column('Results_dailycontrols', 'costsTotal', self.gf('django.db.models.fields.FloatField')(null=True))

        # Changing field 'DailyControls.deswUTimeAvg'
        db.alter_column('Results_dailycontrols', 'deswUTimeAvg', self.gf('django.db.models.fields.FloatField')(null=True))

        # Changing field 'DailyControls.deswATimeAvg'
        db.alter_column('Results_dailycontrols', 'deswATimeAvg', self.gf('django.db.models.fields.FloatField')(null=True))

        # Changing field 'DailyControls.destrEuthanasia'
        db.alter_column('Results_dailycontrols', 'destrEuthanasia', self.gf('django.db.models.fields.FloatField')(null=True))

        # Changing field 'DailyControls.destrSubtotal'
        db.alter_column('Results_dailycontrols', 'destrSubtotal', self.gf('django.db.models.fields.FloatField')(null=True))

        # Changing field 'DailyControls.costSurveillance'
        db.alter_column('Results_dailycontrols', 'costSurveillance', self.gf('django.db.models.fields.FloatField')(null=True))

        # Changing field 'DailyControls.destrCleaning'
        db.alter_column('Results_dailycontrols', 'destrCleaning', self.gf('django.db.models.fields.FloatField')(null=True))

        # Changing field 'DailyControls.destrAppraisal'
        db.alter_column('Results_dailycontrols', 'destrAppraisal', self.gf('django.db.models.fields.FloatField')(null=True))

        # Changing field 'DailyControls.destrDisposal'
        db.alter_column('Results_dailycontrols', 'destrDisposal', self.gf('django.db.models.fields.FloatField')(null=True))

        # Changing field 'DailyByZone.finalZonePerimeter'
        db.alter_column('Results_dailybyzone', 'finalZonePerimeter', self.gf('django.db.models.fields.FloatField')(null=True))

        # Changing field 'DailyByZone.zoneArea'
        db.alter_column('Results_dailybyzone', 'zoneArea', self.gf('django.db.models.fields.FloatField')(null=True))

        # Changing field 'DailyByZone.maxZonePerimeter'
        db.alter_column('Results_dailybyzone', 'maxZonePerimeter', self.gf('django.db.models.fields.FloatField')(null=True))

        # Changing field 'DailyByZone.maxZoneArea'
        db.alter_column('Results_dailybyzone', 'maxZoneArea', self.gf('django.db.models.fields.FloatField')(null=True))

        # Changing field 'DailyByZone.zonePerimeter'
        db.alter_column('Results_dailybyzone', 'zonePerimeter', self.gf('django.db.models.fields.FloatField')(null=True))

        # Changing field 'DailyByZone.finalZoneArea'
        db.alter_column('Results_dailybyzone', 'finalZoneArea', self.gf('django.db.models.fields.FloatField')(null=True))

        # Changing field 'DailyByProductionType.vacwAAll'
        db.alter_column('Results_dailybyproductiontype', 'vacwAAll', self.gf('django.db.models.fields.FloatField')(null=True))

        # Changing field 'DailyByProductionType.vacwADaysInQueue'
        db.alter_column('Results_dailybyproductiontype', 'vacwADaysInQueue', self.gf('django.db.models.fields.FloatField')(null=True))

        # Changing field 'DailyByProductionType.vacwATimeAvg'
        db.alter_column('Results_dailybyproductiontype', 'vacwATimeAvg', self.gf('django.db.models.fields.FloatField')(null=True))

        # Changing field 'DailyByProductionType.vacwAMax'
        db.alter_column('Results_dailybyproductiontype', 'vacwAMax', self.gf('django.db.models.fields.FloatField')(null=True))

        # Changing field 'DailyByProductionType.vacwUTimeAvg'
        db.alter_column('Results_dailybyproductiontype', 'vacwUTimeAvg', self.gf('django.db.models.fields.FloatField')(null=True))

        # Changing field 'DailyByProductionType.vacwATimeMax'
        db.alter_column('Results_dailybyproductiontype', 'vacwATimeMax', self.gf('django.db.models.fields.FloatField')(null=True))

    def backwards(self, orm):

        # Changing field 'DailyControls.vaccSetup'
        db.alter_column('Results_dailycontrols', 'vaccSetup', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'DailyControls.vaccSubtotal'
        db.alter_column('Results_dailycontrols', 'vaccSubtotal', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'DailyControls.vaccVaccination'
        db.alter_column('Results_dailycontrols', 'vaccVaccination', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'DailyControls.destrIndemnification'
        db.alter_column('Results_dailycontrols', 'destrIndemnification', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'DailyControls.costsTotal'
        db.alter_column('Results_dailycontrols', 'costsTotal', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'DailyControls.deswUTimeAvg'
        db.alter_column('Results_dailycontrols', 'deswUTimeAvg', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'DailyControls.deswATimeAvg'
        db.alter_column('Results_dailycontrols', 'deswATimeAvg', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'DailyControls.destrEuthanasia'
        db.alter_column('Results_dailycontrols', 'destrEuthanasia', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'DailyControls.destrSubtotal'
        db.alter_column('Results_dailycontrols', 'destrSubtotal', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'DailyControls.costSurveillance'
        db.alter_column('Results_dailycontrols', 'costSurveillance', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'DailyControls.destrCleaning'
        db.alter_column('Results_dailycontrols', 'destrCleaning', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'DailyControls.destrAppraisal'
        db.alter_column('Results_dailycontrols', 'destrAppraisal', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'DailyControls.destrDisposal'
        db.alter_column('Results_dailycontrols', 'destrDisposal', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'DailyByZone.finalZonePerimeter'
        db.alter_column('Results_dailybyzone', 'finalZonePerimeter', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'DailyByZone.zoneArea'
        db.alter_column('Results_dailybyzone', 'zoneArea', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'DailyByZone.maxZonePerimeter'
        db.alter_column('Results_dailybyzone', 'maxZonePerimeter', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'DailyByZone.maxZoneArea'
        db.alter_column('Results_dailybyzone', 'maxZoneArea', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'DailyByZone.zonePerimeter'
        db.alter_column('Results_dailybyzone', 'zonePerimeter', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'DailyByZone.finalZoneArea'
        db.alter_column('Results_dailybyzone', 'finalZoneArea', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'DailyByProductionType.vacwAAll'
        db.alter_column('Results_dailybyproductiontype', 'vacwAAll', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'DailyByProductionType.vacwADaysInQueue'
        db.alter_column('Results_dailybyproductiontype', 'vacwADaysInQueue', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'DailyByProductionType.vacwATimeAvg'
        db.alter_column('Results_dailybyproductiontype', 'vacwATimeAvg', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'DailyByProductionType.vacwAMax'
        db.alter_column('Results_dailybyproductiontype', 'vacwAMax', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'DailyByProductionType.vacwUTimeAvg'
        db.alter_column('Results_dailybyproductiontype', 'vacwUTimeAvg', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'DailyByProductionType.vacwATimeMax'
        db.alter_column('Results_dailybyproductiontype', 'vacwATimeMax', self.gf('django.db.models.fields.IntegerField')(null=True))
    ...
    models = {
        'Results.dailybyproductiontype': {
            ...
            'vacwAAll': ('django.db.models.fields.FloatField', [], {'blank': 'True', 'null': 'True'}),
        ...
        'Results.dailybyzone': {
            ...
            'day': ('django.db.models.fields.IntegerField', [], {'blank': 'True', 'null': 'True'}),
            'finalZoneArea': ('django.db.models.fields.FloatField', [], {'blank': 'True', 'null': 'True'}),
            'finalZonePerimeter': ('django.db.models.fields.FloatField', [], {'blank': 'True', 'null': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'iteration': ('django.db.models.fields.IntegerField', [], {'blank': 'True', 'null': 'True'}),
            'maxZoneArea': ('django.db.models.fields.FloatField', [], {'blank': 'True', 'null': 'True'}),
            'maxZoneAreaDay': ('django.db.models.fields.IntegerField', [], {'blank': 'True', 'null': 'True'}),
            'maxZonePerimeter': ('django.db.models.fields.FloatField', [], {'blank': 'True', 'null': 'True'}),
