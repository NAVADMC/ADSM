...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DailyByProductionType.tstnUAll'
        db.add_column('Results_dailybyproductiontype', 'tstnUAll',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'DailyByProductionType.tstnUAll'
        db.delete_column('Results_dailybyproductiontype', 'tstnUAll')
    ...
    models = {
        'Results.dailybyproductiontype': {
            ...
            'tstnUAll': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
