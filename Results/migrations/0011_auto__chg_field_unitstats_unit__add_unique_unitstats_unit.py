...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'Results_unitstats', 'unit_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['ScenarioCreator.Unit'], unique=True))
        # Adding unique constraint on 'UnitStats', fields ['unit']
        db.create_unique(u'Results_unitstats', ['unit_id'])
