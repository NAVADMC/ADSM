...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.rename_column('Results_dailybyzone', 'num_separate_areas', 'numSeparateAreas')
        db.rename_column('Results_dailycontrols', 'average_prevalence', 'averagePrevalence')


    def backwards(self, orm):
        db.rename_column('Results_dailybyzone', 'numSeparateAreas', 'num_separate_areas')
        db.rename_column('Results_dailycontrols', 'averagePrevalence', 'average_prevalence')
