...
set parametric
rad(x) = x * pi / 180
plot [0:2*pi] 0.3*sin(t),0.3*cos(t) notitle w l lt 1 lw 3,\
  0.3*sin(t)+sin(rad(30)),0.3*cos(t)+cos(rad(30)) notitle w l lt 1 lw 3,\
  0.3*sin(t)+sin(rad(60)),0.3*cos(t)+cos(rad(60)) notitle w l lt 1 lw 3,\
  0.3*sin(t)+1,0.3*cos(t) notitle w l lt 1 lw 3,\
  0.3*sin(t)+sin(rad(60)),0.3*cos(t)-cos(rad(60)) notitle w l lt 1 lw 3,\
  0.3*sin(t)+sin(rad(30)),0.3*cos(t)-cos(rad(30)) notitle w l lt 1 lw 3,\
  0.3*sin(t),0.3*cos(t)-1 notitle w l lt 1 lw 3,\
  0.3*sin(t)-sin(rad(30)),0.3*cos(t)-cos(rad(30)) notitle w l lt 1 lw 3,\
  0.3*sin(t)-sin(rad(60)),0.3*cos(t)-cos(rad(60)) notitle w l lt 1 lw 3,\
  0.3*sin(t)-1,0.3*cos(t) notitle w l lt 1 lw 3,\
  0.3*sin(t)-sin(rad(60)),0.3*cos(t)+cos(rad(60)) notitle w l lt 1 lw 3,\
