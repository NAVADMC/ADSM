     ...
     ZON_zone_list_t * zones)
{
  ...
  nprodtypes = local_data->production_types->len;
  {
    RPT_bulk_create_t outputs[] = {
      { &local_data->nunits_potentially_traced, "trnUp", RPT_integer,
      ...
      { &local_data->cumul_nunits_potentially_traced, "trcUp", RPT_integer,
        RPT_NoSubcategory, NULL, 0,
        RPT_NoSubcategory, NULL, 0,
      ...
      { &local_data->nunits_traced, "trnU", RPT_integer,
        RPT_NoSubcategory, NULL, 0,
        RPT_NoSubcategory, NULL, 0,
        self->outputs, local_data->daily_outputs },
      ...
      { &local_data->cumul_nunits_traced, "trcU", RPT_integer,
        RPT_NoSubcategory, NULL, 0,
        RPT_NoSubcategory, NULL, 0,
        self->outputs, local_data->cumul_outputs },
      ...
      { &local_data->nanimals_potentially_traced, "trnAp", RPT_real,
        RPT_NoSubcategory, NULL, 0,
        RPT_NoSubcategory, NULL, 0,
        self->outputs, local_data->daily_outputs },
      ...
      { &local_data->cumul_nanimals_potentially_traced, "trcAp", RPT_real,
        RPT_NoSubcategory, NULL, 0,
        RPT_NoSubcategory, NULL, 0,
        self->outputs, local_data->cumul_outputs },
      ...
      { &local_data->nanimals_traced, "trnA", RPT_real,
        RPT_NoSubcategory, NULL, 0,
        RPT_NoSubcategory, NULL, 0,
        self->outputs, local_data->daily_outputs },
      ...
      { &local_data->cumul_nanimals_traced, "trcA", RPT_real,
        RPT_NoSubcategory, NULL, 0,
        RPT_NoSubcategory, NULL, 0,
        self->outputs, local_data->cumul_outputs },
