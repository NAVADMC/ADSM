     ...
     ZON_zone_list_t * zones)
{
  ...
  nprodtypes = local_data->production_types->len;
  {
    RPT_bulk_create_t outputs[] = {
      { &local_data->num_units_exposed, "expnUAll", RPT_integer,
      ...
      { &local_data->cumul_num_units_exposed, "expcUAll", RPT_integer,
        RPT_NoSubcategory, NULL, 0,
        RPT_NoSubcategory, NULL, 0,
      ...
      { &local_data->num_animals_exposed, "expnAAll", RPT_real,
        RPT_NoSubcategory, NULL, 0,
        RPT_NoSubcategory, NULL, 0,
        self->outputs, local_data->daily_outputs },
      ...
      { &local_data->cumul_num_animals_exposed, "expcAAll", RPT_real,
        RPT_NoSubcategory, NULL, 0,
        RPT_NoSubcategory, NULL, 0,
        self->outputs, local_data->cumul_outputs },
      ...
      { &local_data->num_adequate_exposures, "adqnUAll", RPT_integer,
        RPT_NoSubcategory, NULL, 0,
        RPT_NoSubcategory, NULL, 0,
        self->outputs, local_data->daily_outputs },
