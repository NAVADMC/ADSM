...
#ifndef RING_DESTRUCTION_MODEL_H
#define RING_DESTRUCTION_MODEL_H

spreadmodel_model_t *ring_destruction_model_new (scew_element * params, UNT_unit_list_t *,
