...
#define is_listening_for trace_quarantine_model_is_listening_for
#define has_pending_actions trace_quarantine_model_has_pending_actions
#define has_pending_infections trace_quarantine_model_has_pending_infections
#define to_string trace_quarantine_model_to_string
#define local_printf trace_quarantine_model_printf
#define local_fprintf trace_quarantine_model_fprintf
