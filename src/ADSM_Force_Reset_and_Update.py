...
if (getattr(sys, 'frozen', False) and 'force_reset_and_update.now' in str(sys.executable).lower()) or (not getattr(sys, 'frozen', False) and 'force_reset_and_update.now' in str(__file__).lower()):
