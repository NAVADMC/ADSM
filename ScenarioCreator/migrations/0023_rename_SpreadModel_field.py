...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.rename_column('ScenarioCreator_productiontypepairtransmission', 'indirect_contact_spread_model_id', 'indirect_contact_spread_id')
        db.rename_column('ScenarioCreator_productiontypepairtransmission', 'direct_contact_spread_model_id', 'direct_contact_spread_id')
        db.rename_column('ScenarioCreator_productiontypepairtransmission', 'airborne_contact_spread_model_id', 'airborne_spread_id')


    def backwards(self, orm):
        db.rename_column('ScenarioCreator_productiontypepairtransmission', 'indirect_contact_spread_id', 'indirect_contact_spread_model_id')
        db.rename_column('ScenarioCreator_productiontypepairtransmission', 'direct_contact_spread_id', 'direct_contact_spread_model_id')
        db.rename_column('ScenarioCreator_productiontypepairtransmission', 'airborne_spread_id', 'airborne_contact_spread_model_id')
    ...
    models = {
        ...
        'ScenarioCreator.controlmasterplan': {
            ...
            'destruction_capacity': ('django.db.models.fields.related.ForeignKey', [], {'null': 'True', 'related_name': "'+'", 'to': "orm['ScenarioCreator.RelationalFunction']", 'blank': 'True'}),
            ...
            'vaccination_capacity': ('django.db.models.fields.related.ForeignKey', [], {'null': 'True', 'related_name': "'+'", 'to': "orm['ScenarioCreator.RelationalFunction']", 'blank': 'True'}),
        ...
        'ScenarioCreator.controlprotocol': {
            ...
            'destruction_priority': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'default': '5', 'blank': 'True'}),
            ...
            'detection_probability_for_observed_time_in_clinical': ('django.db.models.fields.related.ForeignKey', [], {'null': 'True', 'related_name': "'+'", 'to': "orm['ScenarioCreator.RelationalFunction']", 'blank': 'True'}),
            'detection_probability_report_vs_first_detection': ('django.db.models.fields.related.ForeignKey', [], {'null': 'True', 'related_name': "'+'", 'to': "orm['ScenarioCreator.RelationalFunction']", 'blank': 'True'}),
            ...
            'trace_result_delay': ('django.db.models.fields.related.ForeignKey', [], {'null': 'True', 'related_name': "'+'", 'to': "orm['ScenarioCreator.ProbabilityFunction']", 'blank': 'True'}),
            ...
            'vaccination_priority': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'default': '5', 'blank': 'True'}),
            'vaccination_ring_radius': ('django.db.models.fields.FloatField', [], {'null': 'True', 'blank': 'True'}),
            'vaccine_immune_period': ('django.db.models.fields.related.ForeignKey', [], {'null': 'True', 'related_name': "'+'", 'to': "orm['ScenarioCreator.ProbabilityFunction']", 'blank': 'True'})
        },
        ...
        'ScenarioCreator.diseaseprogression': {
            ...
            'disease_prevalence': ('django.db.models.fields.related.ForeignKey', [], {'null': 'True', 'related_name': "'+'", 'to': "orm['ScenarioCreator.RelationalFunction']", 'blank': 'True'}),
        ...
        'ScenarioCreator.outputsettings': {
            ...
            'maximum_iterations_for_daily_output': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'default': '3', 'blank': 'True'}),
        ...
        'ScenarioCreator.productiontypepairtransmission': {
            ...
            'airborne_spread': ('django.db.models.fields.related.ForeignKey', [], {'null': 'True', 'related_name': "'airborne_spread_pair'", 'to': "orm['ScenarioCreator.AirborneSpread']", 'blank': 'True'}),
            ...
            'direct_contact_spread': ('django.db.models.fields.related.ForeignKey', [], {'null': 'True', 'related_name': "'direct_spread_pair'", 'to': "orm['ScenarioCreator.DirectSpread']", 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'indirect_contact_spread': ('django.db.models.fields.related.ForeignKey', [], {'null': 'True', 'related_name': "'indirect_spread_pair'", 'to': "orm['ScenarioCreator.IndirectSpread']", 'blank': 'True'}),
        ...
        'ScenarioCreator.zoneeffectonproductiontype': {
            ...
            'zone_direct_movement': ('django.db.models.fields.related.ForeignKey', [], {'null': 'True', 'related_name': "'+'", 'to': "orm['ScenarioCreator.RelationalFunction']", 'blank': 'True'}),
            'zone_indirect_movement': ('django.db.models.fields.related.ForeignKey', [], {'null': 'True', 'related_name': "'+'", 'to': "orm['ScenarioCreator.RelationalFunction']", 'blank': 'True'})
        }
    }
