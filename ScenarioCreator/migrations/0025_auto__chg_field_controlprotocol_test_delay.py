...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ControlProtocol.test_delay'
        db.alter_column('ScenarioCreator_controlprotocol', 'test_delay_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['ScenarioCreator.ProbabilityFunction'], null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'ControlProtocol.test_delay'
        raise RuntimeError("Cannot reverse this migration. 'ControlProtocol.test_delay' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'ControlProtocol.test_delay'
        db.alter_column('ScenarioCreator_controlprotocol', 'test_delay_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['ScenarioCreator.ProbabilityFunction']))
