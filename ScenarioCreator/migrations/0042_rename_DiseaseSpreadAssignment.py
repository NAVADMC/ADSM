...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.rename_table('ScenarioCreator_productiontypepairtransmission', 'ScenarioCreator_diseasespreadassignment')
    
    
    def backwards(self, orm):
        db.rename_table('ScenarioCreator_diseasespreadassignment', 'ScenarioCreator_productiontypepairtransmission')
    ...
    models = {
        'ScenarioCreator.airbornespread': {
            ...
            'transport_delay': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'+'", 'to': "orm['ScenarioCreator.ProbabilityFunction']", 'null': 'True', 'blank': 'True'})
        },
        'ScenarioCreator.controlmasterplan': {
            'Meta': {'object_name': 'ControlMasterPlan'},
            'destruction_capacity': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'+'", 'to': "orm['ScenarioCreator.RelationalFunction']", 'null': 'True', 'blank': 'True'}),
            ...
            'vaccination_capacity': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'+'", 'to': "orm['ScenarioCreator.RelationalFunction']", 'null': 'True', 'blank': 'True'}),
        ...
        'ScenarioCreator.controlprotocol': {
            ...
            'destruction_priority': ('django.db.models.fields.PositiveIntegerField', [], {'default': '5', 'null': 'True', 'blank': 'True'}),
            ...
            'detection_probability_for_observed_time_in_clinical': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'+'", 'to': "orm['ScenarioCreator.RelationalFunction']", 'null': 'True', 'blank': 'True'}),
            'detection_probability_report_vs_first_detection': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'+'", 'to': "orm['ScenarioCreator.RelationalFunction']", 'null': 'True', 'blank': 'True'}),
            ...
            'name': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'test_delay': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'+'", 'to': "orm['ScenarioCreator.ProbabilityFunction']", 'null': 'True', 'blank': 'True'}),
            ...
            'trace_result_delay': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'+'", 'to': "orm['ScenarioCreator.ProbabilityFunction']", 'null': 'True', 'blank': 'True'}),
            ...
            'vaccination_priority': ('django.db.models.fields.PositiveIntegerField', [], {'default': '5', 'null': 'True', 'blank': 'True'}),
            'vaccination_ring_radius': ('django.db.models.fields.FloatField', [], {'null': 'True', 'blank': 'True'}),
            'vaccine_immune_period': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'+'", 'to': "orm['ScenarioCreator.ProbabilityFunction']", 'null': 'True', 'blank': 'True'})
        },
        'ScenarioCreator.directspread': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'infection_probability': ('ScenarioCreator.custom_fields.PercentField', [], {'null': 'True', 'blank': 'True'}),
        ...
        'ScenarioCreator.diseaseprogression': {
            ...
            'disease_prevalence': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'+'", 'to': "orm['ScenarioCreator.RelationalFunction']", 'null': 'True', 'blank': 'True'}),
        ...
        'ScenarioCreator.diseasespreadassignment': {
            'Meta': {'unique_together': "(('source_production_type', 'destination_production_type'),)", 'object_name': 'DiseaseSpreadAssignment'},
            'airborne_spread': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'airborne_spread_pair'", 'to': "orm['ScenarioCreator.AirborneSpread']", 'null': 'True', 'blank': 'True'}),
            ...
            'direct_contact_spread': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'direct_spread_pair'", 'to': "orm['ScenarioCreator.DirectSpread']", 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'indirect_contact_spread': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'indirect_spread_pair'", 'to': "orm['ScenarioCreator.IndirectSpread']", 'null': 'True', 'blank': 'True'}),
        ...
        'ScenarioCreator.zoneeffect': {
            ...
            'zone_direct_movement': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'+'", 'to': "orm['ScenarioCreator.RelationalFunction']", 'null': 'True', 'blank': 'True'}),
            'zone_indirect_movement': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'+'", 'to': "orm['ScenarioCreator.RelationalFunction']", 'null': 'True', 'blank': 'True'})
        },
        'ScenarioCreator.zoneeffectassignment': {
            'Meta': {'object_name': 'ZoneEffectAssignment'},
            'effect': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['ScenarioCreator.ZoneEffect']", 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'production_type': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['ScenarioCreator.ProductionType']"}),
