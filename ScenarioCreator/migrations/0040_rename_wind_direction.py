...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.rename_column('ScenarioCreator_airbornespread', 'wind_direction_start', 'exposure_direction_start')
        db.rename_column('ScenarioCreator_airbornespread', 'wind_direction_end', 'exposure_direction_end')


    def backwards(self, orm):
        db.rename_column('ScenarioCreator_airbornespread', 'exposure_direction_start', 'wind_direction_start')
        db.rename_column('ScenarioCreator_airbornespread', 'exposure_direction_end', 'wind_direction_end')
