...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ProbabilityFunction.graph'
        db.add_column('ScenarioCreator_probabilityfunction', 'graph',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, to=orm['ScenarioCreator.RelationalFunction'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ProbabilityFunction.graph'
        db.delete_column('ScenarioCreator_probabilityfunction', 'graph_id')
    ...
    models = {
        ...
        'ScenarioCreator.controlmasterplan': {
            ...
            'destruction_capacity': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'to': "orm['ScenarioCreator.RelationalFunction']", 'related_name': "'+'", 'null': 'True'}),
            ...
            'vaccination_capacity': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'to': "orm['ScenarioCreator.RelationalFunction']", 'related_name': "'+'", 'null': 'True'}),
        ...
        'ScenarioCreator.controlprotocol': {
            ...
            'detection_probability_for_observed_time_in_clinical': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'to': "orm['ScenarioCreator.RelationalFunction']", 'related_name': "'+'", 'null': 'True'}),
            'detection_probability_report_vs_first_detection': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'to': "orm['ScenarioCreator.RelationalFunction']", 'related_name': "'+'", 'null': 'True'}),
            ...
            'trace_result_delay': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'to': "orm['ScenarioCreator.ProbabilityFunction']", 'related_name': "'+'", 'null': 'True'}),
            ...
            'vaccine_immune_period': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'to': "orm['ScenarioCreator.ProbabilityFunction']", 'related_name': "'+'", 'null': 'True'})
        },
        ...
        'ScenarioCreator.diseasereaction': {
            ...
            'disease_prevalence': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'to': "orm['ScenarioCreator.RelationalFunction']", 'related_name': "'+'", 'null': 'True'}),
        ...
        'ScenarioCreator.productiontypepairtransmission': {
            ...
            'airborne_contact_spread_model': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'to': "orm['ScenarioCreator.AirborneSpreadModel']", 'related_name': "'airborne_spread_pair'", 'null': 'True'}),
            ...
            'direct_contact_spread_model': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'to': "orm['ScenarioCreator.DirectSpreadModel']", 'related_name': "'direct_spread_pair'", 'null': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'indirect_contact_spread_model': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'to': "orm['ScenarioCreator.IndirectSpreadModel']", 'related_name': "'indirect_spread_pair'", 'null': 'True'}),
        ...
        'ScenarioCreator.zoneeffectonproductiontype': {
            ...
            'zone_direct_movement': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'to': "orm['ScenarioCreator.RelationalFunction']", 'related_name': "'+'", 'null': 'True'}),
            'zone_indirect_movement': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'to': "orm['ScenarioCreator.RelationalFunction']", 'related_name': "'+'", 'null': 'True'})
        }
    }
