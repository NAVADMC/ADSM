...
class Migration(SchemaMigration):
    ...
    models = {
        'ScenarioCreator.airbornespread': {
            ...
            'transport_delay': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['ScenarioCreator.ProbabilityFunction']", 'null': 'True', 'related_name': "'+'", 'blank': 'True'}),
        ...
        'ScenarioCreator.controlmasterplan': {
            ...
            'destruction_capacity': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['ScenarioCreator.RelationalFunction']", 'null': 'True', 'related_name': "'+'", 'blank': 'True'}),
            ...
            'vaccination_capacity': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['ScenarioCreator.RelationalFunction']", 'null': 'True', 'related_name': "'+'", 'blank': 'True'}),
        ...
        'ScenarioCreator.controlprotocol': {
            ...
            'detection_probability_for_observed_time_in_clinical': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['ScenarioCreator.RelationalFunction']", 'null': 'True', 'related_name': "'+'", 'blank': 'True'}),
            'detection_probability_report_vs_first_detection': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['ScenarioCreator.RelationalFunction']", 'null': 'True', 'related_name': "'+'", 'blank': 'True'}),
            ...
            'name': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'test_delay': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['ScenarioCreator.ProbabilityFunction']", 'null': 'True', 'related_name': "'+'", 'blank': 'True'}),
            ...
            'trace_result_delay': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['ScenarioCreator.ProbabilityFunction']", 'null': 'True', 'related_name': "'+'", 'blank': 'True'}),
            ...
            'vaccine_immune_period': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['ScenarioCreator.ProbabilityFunction']", 'null': 'True', 'related_name': "'+'", 'blank': 'True'})
        },
        ...
        'ScenarioCreator.diseaseprogression': {
            ...
            'disease_prevalence': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['ScenarioCreator.RelationalFunction']", 'null': 'True', 'related_name': "'+'", 'blank': 'True'}),
        ...
        'ScenarioCreator.outputsettings': {
            ...
            'maximum_iterations_for_daily_output': ('django.db.models.fields.PositiveIntegerField', [], {'null': 'True', 'blank': 'True', 'default': '3'}),
        ...
        'ScenarioCreator.productiontypepairtransmission': {
            ...
            'airborne_spread': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['ScenarioCreator.AirborneSpread']", 'null': 'True', 'related_name': "'airborne_spread_pair'", 'blank': 'True'}),
            ...
            'direct_contact_spread': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['ScenarioCreator.DirectSpread']", 'null': 'True', 'related_name': "'direct_spread_pair'", 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'indirect_contact_spread': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['ScenarioCreator.IndirectSpread']", 'null': 'True', 'related_name': "'indirect_spread_pair'", 'blank': 'True'}),
        ...
        'ScenarioCreator.zoneeffectonproductiontype': {
            ...
            'zone_direct_movement': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['ScenarioCreator.RelationalFunction']", 'null': 'True', 'related_name': "'+'", 'blank': 'True'}),
            'zone_indirect_movement': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['ScenarioCreator.RelationalFunction']", 'null': 'True', 'related_name': "'+'", 'blank': 'True'})
        }
    }
