...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'ControlProtocol.trace_result_delay_pdf'
        db.rename_column('ScenarioCreator_controlprotocol', 'trace_result_delay_pdf_id', 'trace_result_delay_id')

        # Adding field 'ControlProtocol.trace_result_delay'
        # db.add_column('ScenarioCreator_controlprotocol', 'trace_result_delay',
        #               self.gf('django.db.models.fields.related.ForeignKey')(related_name='+', null=True, to=orm['ScenarioCreator.ProbabilityFunction'], blank=True),
        #               keep_default=False)


    def backwards(self, orm):
        raise RuntimeError(
            "Cannot reverse this migration. 'IndirectSpreadModel.transport_delay_pdf' and its values cannot be restored.")
    ...
    models = {
        'ScenarioCreator.airbornespreadmodel': {
            ...
            'transport_delay_pdf': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'+'", 'to': "orm['ScenarioCreator.ProbabilityFunction']"}),
        ...
        'ScenarioCreator.controlmasterplan': {
            ...
            'destruction_capacity_relid': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'+'", 'null': 'True', 'to': "orm['ScenarioCreator.RelationalFunction']", 'blank': 'True'}),
            ...
            'vaccination_capacity_relid': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'+'", 'null': 'True', 'to': "orm['ScenarioCreator.RelationalFunction']", 'blank': 'True'}),
        ...
        'ScenarioCreator.controlprotocol': {
            ...
            'detection_probability_for_observed_time_in_clinical_relid': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'+'", 'null': 'True', 'to': "orm['ScenarioCreator.RelationalFunction']", 'blank': 'True'}),
            'detection_probability_report_vs_first_detection_relid': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'+'", 'null': 'True', 'to': "orm['ScenarioCreator.RelationalFunction']", 'blank': 'True'}),
            ...
            'name': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'test_delay_pdf': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'+'", 'to': "orm['ScenarioCreator.ProbabilityFunction']"}),
            ...
            'vaccine_immune_period_pdf': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'+'", 'null': 'True', 'to': "orm['ScenarioCreator.ProbabilityFunction']", 'blank': 'True'})
        },
        ...
        'ScenarioCreator.directspreadmodel': {
            ...
            'distance_pdf': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'+'", 'to': "orm['ScenarioCreator.ProbabilityFunction']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'ScenarioCreator.diseasereaction': {
            ...
            '_disease': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['ScenarioCreator.Disease']"}),
            'disease_clinical_period_pdf': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'+'", 'to': "orm['ScenarioCreator.ProbabilityFunction']"}),
            'disease_immune_period_pdf': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'+'", 'to': "orm['ScenarioCreator.ProbabilityFunction']"}),
            'disease_latent_period_pdf': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'+'", 'to': "orm['ScenarioCreator.ProbabilityFunction']"}),
            'disease_prevalence_relid': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'+'", 'null': 'True', 'to': "orm['ScenarioCreator.RelationalFunction']", 'blank': 'True'}),
            'disease_subclinical_period_pdf': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'+'", 'to': "orm['ScenarioCreator.ProbabilityFunction']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '255'})
        },
        ...
        'ScenarioCreator.zoneeffectonproductiontype': {
            ...
            'zone_direct_movement_relid': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'+'", 'null': 'True', 'to': "orm['ScenarioCreator.RelationalFunction']", 'blank': 'True'}),
            'zone_indirect_movement_relid': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'+'", 'null': 'True', 'to': "orm['ScenarioCreator.RelationalFunction']", 'blank': 'True'})
        }
    }
