...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'DiseaseReactionAssignment.reaction'
        db.alter_column('ScenarioCreator_diseasereactionassignment', 'reaction_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['ScenarioCreator.DiseaseReaction']))

        # Changing field 'ProtocolAssignment.control_protocol'
        db.alter_column('ScenarioCreator_protocolassignment', 'control_protocol_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['ScenarioCreator.ControlProtocol']))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'DiseaseReactionAssignment.reaction'
        raise RuntimeError("Cannot reverse this migration. 'DiseaseReactionAssignment.reaction' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'DiseaseReactionAssignment.reaction'
        db.alter_column('ScenarioCreator_diseasereactionassignment', 'reaction_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['ScenarioCreator.DiseaseReaction']))

        # User chose to not deal with backwards NULL issues for 'ProtocolAssignment.control_protocol'
        raise RuntimeError("Cannot reverse this migration. 'ProtocolAssignment.control_protocol' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'ProtocolAssignment.control_protocol'
        db.alter_column('ScenarioCreator_protocolassignment', 'control_protocol_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['ScenarioCreator.ControlProtocol']))
    ...
    models = {
        ...
        'ScenarioCreator.controlmasterplan': {
            ...
            'destruction_capacity': ('django.db.models.fields.related.ForeignKey', [], {'null': 'True', 'related_name': "'+'", 'blank': 'True', 'to': "orm['ScenarioCreator.RelationalFunction']"}),
            ...
            'vaccination_capacity': ('django.db.models.fields.related.ForeignKey', [], {'null': 'True', 'related_name': "'+'", 'blank': 'True', 'to': "orm['ScenarioCreator.RelationalFunction']"}),
        ...
        'ScenarioCreator.controlprotocol': {
            ...
            'detection_probability_for_observed_time_in_clinical': ('django.db.models.fields.related.ForeignKey', [], {'null': 'True', 'related_name': "'+'", 'blank': 'True', 'to': "orm['ScenarioCreator.RelationalFunction']"}),
            'detection_probability_report_vs_first_detection': ('django.db.models.fields.related.ForeignKey', [], {'null': 'True', 'related_name': "'+'", 'blank': 'True', 'to': "orm['ScenarioCreator.RelationalFunction']"}),
            ...
            'trace_result_delay': ('django.db.models.fields.related.ForeignKey', [], {'null': 'True', 'related_name': "'+'", 'blank': 'True', 'to': "orm['ScenarioCreator.ProbabilityFunction']"}),
            ...
            'vaccine_immune_period': ('django.db.models.fields.related.ForeignKey', [], {'null': 'True', 'related_name': "'+'", 'blank': 'True', 'to': "orm['ScenarioCreator.ProbabilityFunction']"})
        },
        'ScenarioCreator.customoutputs': {
            ...
            'outputsettings_ptr': ('django.db.models.fields.related.OneToOneField', [], {'unique': 'True', 'primary_key': 'True', 'to': "orm['ScenarioCreator.OutputSettings']"}),
        ...
        'ScenarioCreator.diseasereaction': {
            ...
            'disease_prevalence': ('django.db.models.fields.related.ForeignKey', [], {'null': 'True', 'related_name': "'+'", 'blank': 'True', 'to': "orm['ScenarioCreator.RelationalFunction']"}),
        ...
        'ScenarioCreator.diseasereactionassignment': {
            ...
            'reaction': ('django.db.models.fields.related.ForeignKey', [], {'null': 'True', 'blank': 'True', 'to': "orm['ScenarioCreator.DiseaseReaction']"})
        },
        ...
        'ScenarioCreator.productiontypepairtransmission': {
            ...
            'airborne_contact_spread_model': ('django.db.models.fields.related.ForeignKey', [], {'null': 'True', 'related_name': "'airborne_spread_pair'", 'blank': 'True', 'to': "orm['ScenarioCreator.AirborneSpreadModel']"}),
            ...
            'direct_contact_spread_model': ('django.db.models.fields.related.ForeignKey', [], {'null': 'True', 'related_name': "'direct_spread_pair'", 'blank': 'True', 'to': "orm['ScenarioCreator.DirectSpreadModel']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'indirect_contact_spread_model': ('django.db.models.fields.related.ForeignKey', [], {'null': 'True', 'related_name': "'indirect_spread_pair'", 'blank': 'True', 'to': "orm['ScenarioCreator.IndirectSpreadModel']"}),
        ...
        'ScenarioCreator.zoneeffectonproductiontype': {
            ...
            'zone_direct_movement': ('django.db.models.fields.related.ForeignKey', [], {'null': 'True', 'related_name': "'+'", 'blank': 'True', 'to': "orm['ScenarioCreator.RelationalFunction']"}),
            'zone_indirect_movement': ('django.db.models.fields.related.ForeignKey', [], {'null': 'True', 'related_name': "'+'", 'blank': 'True', 'to': "orm['ScenarioCreator.RelationalFunction']"})
        }
    }
