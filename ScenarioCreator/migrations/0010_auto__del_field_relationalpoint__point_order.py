...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'RelationalPoint._point_order'
        db.delete_column('ScenarioCreator_relationalpoint', '_point_order')


    def backwards(self, orm):
        # Adding field 'RelationalPoint._point_order'
        db.add_column('ScenarioCreator_relationalpoint', '_point_order',
    ...
    models = {
        ...
        'ScenarioCreator.productiontypepairtransmission': {
            ...
            'airborne_contact_spread_model': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'airborne_spread_pair'", 'to': "orm['ScenarioCreator.AirborneSpreadModel']", 'null': 'True'}),
            ...
            'direct_contact_spread_model': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'direct_spread_pair'", 'to': "orm['ScenarioCreator.DirectSpreadModel']", 'null': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'indirect_contact_spread_model': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'indirect_spread_pair'", 'to': "orm['ScenarioCreator.IndirectSpreadModel']", 'null': 'True'}),
