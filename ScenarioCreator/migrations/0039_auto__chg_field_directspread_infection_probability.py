...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'DirectSpread.infection_probability'
        db.alter_column('ScenarioCreator_directspread', 'infection_probability', self.gf('ScenarioCreator.custom_fields.PercentField')(null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'DirectSpread.infection_probability'
        raise RuntimeError("Cannot reverse this migration. 'DirectSpread.infection_probability' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'DirectSpread.infection_probability'
        db.alter_column('ScenarioCreator_directspread', 'infection_probability', self.gf('ScenarioCreator.custom_fields.PercentField')())
    ...
    models = {
        'ScenarioCreator.airbornespread': {
            ...
            'transport_delay': ('django.db.models.fields.related.ForeignKey', [], {'null': 'True', 'related_name': "'+'", 'blank': 'True', 'to': "orm['ScenarioCreator.ProbabilityFunction']"}),
        ...
        'ScenarioCreator.controlprotocol': {
            ...
            'name': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'test_delay': ('django.db.models.fields.related.ForeignKey', [], {'null': 'True', 'related_name': "'+'", 'blank': 'True', 'to': "orm['ScenarioCreator.ProbabilityFunction']"}),
        ...
        'ScenarioCreator.productiontypepairtransmission': {
            ...
            'airborne_spread': ('django.db.models.fields.related.ForeignKey', [], {'null': 'True', 'related_name': "'airborne_spread_pair'", 'blank': 'True', 'to': "orm['ScenarioCreator.AirborneSpread']"}),
            ...
            'direct_contact_spread': ('django.db.models.fields.related.ForeignKey', [], {'null': 'True', 'related_name': "'direct_spread_pair'", 'blank': 'True', 'to': "orm['ScenarioCreator.DirectSpread']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'indirect_contact_spread': ('django.db.models.fields.related.ForeignKey', [], {'null': 'True', 'related_name': "'indirect_spread_pair'", 'blank': 'True', 'to': "orm['ScenarioCreator.IndirectSpread']"}),
        ...
        'ScenarioCreator.zoneeffectassignment': {
            ...
            'effect': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'to': "orm['ScenarioCreator.ZoneEffect']", 'null': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'production_type': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['ScenarioCreator.ProductionType']"}),
