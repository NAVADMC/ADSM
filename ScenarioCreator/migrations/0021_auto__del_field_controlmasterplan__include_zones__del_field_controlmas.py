...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'ControlMasterPlan._include_zones'
        db.delete_column('ScenarioCreator_controlmasterplan', '_include_zones')

        # Deleting field 'ControlMasterPlan._include_tracing'
        db.delete_column('ScenarioCreator_controlmasterplan', '_include_tracing')

        # Deleting field 'ControlMasterPlan._include_vaccination'
        db.delete_column('ScenarioCreator_controlmasterplan', '_include_vaccination')

        # Deleting field 'ControlMasterPlan._include_detection'
        db.delete_column('ScenarioCreator_controlmasterplan', '_include_detection')

        # Deleting field 'ControlMasterPlan._include_tracing_unit_exam'
        db.delete_column('ScenarioCreator_controlmasterplan', '_include_tracing_unit_exam')

        # Deleting field 'ControlMasterPlan._include_tracing_testing'
        db.delete_column('ScenarioCreator_controlmasterplan', '_include_tracing_testing')

        # Deleting field 'ControlMasterPlan._include_destruction'
        db.delete_column('ScenarioCreator_controlmasterplan', '_include_destruction')


    def backwards(self, orm):
        # Adding field 'ControlMasterPlan._include_zones'
        db.add_column('ScenarioCreator_controlmasterplan', '_include_zones',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'ControlMasterPlan._include_tracing'
        db.add_column('ScenarioCreator_controlmasterplan', '_include_tracing',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'ControlMasterPlan._include_vaccination'
        db.add_column('ScenarioCreator_controlmasterplan', '_include_vaccination',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'ControlMasterPlan._include_detection'
        db.add_column('ScenarioCreator_controlmasterplan', '_include_detection',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'ControlMasterPlan._include_tracing_unit_exam'
        db.add_column('ScenarioCreator_controlmasterplan', '_include_tracing_unit_exam',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'ControlMasterPlan._include_tracing_testing'
        db.add_column('ScenarioCreator_controlmasterplan', '_include_tracing_testing',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'ControlMasterPlan._include_destruction'
        db.add_column('ScenarioCreator_controlmasterplan', '_include_destruction',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)
    ...
    models = {
        ...
        'ScenarioCreator.productiontypepairtransmission': {
            ...
            'airborne_contact_spread_model': ('django.db.models.fields.related.ForeignKey', [], {'null': 'True', 'to': "orm['ScenarioCreator.AirborneSpreadModel']", 'blank': 'True', 'related_name': "'airborne_spread_pair'"}),
            ...
            'direct_contact_spread_model': ('django.db.models.fields.related.ForeignKey', [], {'null': 'True', 'to': "orm['ScenarioCreator.DirectSpreadModel']", 'blank': 'True', 'related_name': "'direct_spread_pair'"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'indirect_contact_spread_model': ('django.db.models.fields.related.ForeignKey', [], {'null': 'True', 'to': "orm['ScenarioCreator.IndirectSpreadModel']", 'blank': 'True', 'related_name': "'indirect_spread_pair'"}),
