...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'ProductionType', fields ['name']
        db.create_unique('ScenarioCreator_productiontype', ['name'])


    def backwards(self, orm):
        # Removing unique constraint on 'ProductionType', fields ['name']
        db.delete_unique('ScenarioCreator_productiontype', ['name'])
    ...
    models = {
        ...
        'ScenarioCreator.controlmasterplan': {
            ...
            'destrucion_reason_order': ('django.db.models.fields.CharField', [], {'max_length': '255', 'default': "'Basic, Trace fwd direct, Trace fwd indirect, Trace back direct, Trace back indirect, Ring'"}),
