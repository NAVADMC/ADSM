...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.rename_column('ScenarioCreator_diseaseprogressionassignment', 'reaction_id', 'progression_id')


    def backwards(self, orm):
        db.rename_column('ScenarioCreator_diseaseprogressionassignment', 'progression_id', 'reaction_id')
    ...
    models = {
        ...
        'ScenarioCreator.productiontypepairtransmission': {
            ...
            'airborne_contact_spread_model': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'null': 'True', 'to': "orm['ScenarioCreator.AirborneSpreadModel']", 'related_name': "'airborne_spread_pair'"}),
            ...
            'direct_contact_spread_model': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'null': 'True', 'to': "orm['ScenarioCreator.DirectSpreadModel']", 'related_name': "'direct_spread_pair'"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'indirect_contact_spread_model': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'null': 'True', 'to': "orm['ScenarioCreator.IndirectSpreadModel']", 'related_name': "'indirect_spread_pair'"}),
