...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        for func in orm.ProbabilityFunction.objects.all():
            if func.equation_type == "Point":
                func.equation_type = "Fixed Value"
                func.save()
    ...
    models = {
        ...
        'ScenarioCreator.productiontypepairtransmission': {
            ...
            'airborne_contact_spread_model': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'airborne_spread_pair'", 'to': "orm['ScenarioCreator.AirborneSpreadModel']", 'null': 'True', 'blank': 'True'}),
            ...
            'direct_contact_spread_model': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'direct_spread_pair'", 'to': "orm['ScenarioCreator.DirectSpreadModel']", 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'indirect_contact_spread_model': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'indirect_spread_pair'", 'to': "orm['ScenarioCreator.IndirectSpreadModel']", 'null': 'True', 'blank': 'True'}),
