...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.rename_column('ScenarioCreator_zoneeffectonproductiontype', 'zone_direct_movement_relid_id', 'zone_direct_movement_id')
        db.rename_column('ScenarioCreator_zoneeffectonproductiontype', 'zone_indirect_movement_relid_id', 'zone_indirect_movement_id')
        db.rename_column('ScenarioCreator_directspreadmodel', 'movement_control_relid_id', 'movement_control_id')
        db.rename_column('ScenarioCreator_controlprotocol', 'detection_probability_report_vs_first_detection_relid_id', 'detection_probability_report_vs_first_detection_id')
        db.rename_column('ScenarioCreator_controlprotocol', 'detection_probability_for_observed_time_in_clinical_relid_id', 'detection_probability_for_observed_time_in_clinical_id')
        db.rename_column('ScenarioCreator_indirectspreadmodel', 'movement_control_relid_id', 'movement_control_id')
        db.rename_column('ScenarioCreator_diseasereaction', 'disease_prevalence_relid_id', 'disease_prevalence_id')
        db.rename_column('ScenarioCreator_controlmasterplan', 'destruction_capacity_relid_id', 'destruction_capacity_id')
        db.rename_column('ScenarioCreator_controlmasterplan', 'vaccination_capacity_relid_id', 'vaccination_capacity_id')
