...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'OutputSettings.daily_states_filename'
        db.delete_column('ScenarioCreator_outputsettings', 'daily_states_filename')

        # Deleting field 'OutputSettings.maximum_iterations_for_daily_output'
        db.delete_column('ScenarioCreator_outputsettings', 'maximum_iterations_for_daily_output')

        # Deleting field 'OutputSettings.save_all_daily_outputs'
        db.delete_column('ScenarioCreator_outputsettings', 'save_all_daily_outputs')

        # Deleting field 'OutputSettings.map_directory'
        db.delete_column('ScenarioCreator_outputsettings', 'map_directory')

        db.rename_column('ScenarioCreator_outputsettings', 'write_map_output', 'save_map_output')

        # Adding field 'OutputSettings.save_daily_unit_states'
        db.add_column('ScenarioCreator_outputsettings', 'save_daily_unit_states',
    ...
    models = {
        'ScenarioCreator.airbornespread': {
            ...
            'transport_delay': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'to': "orm['ScenarioCreator.ProbabilityFunction']", 'null': 'True', 'related_name': "'+'"}),
        ...
        'ScenarioCreator.controlmasterplan': {
            ...
            'destruction_capacity': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'to': "orm['ScenarioCreator.RelationalFunction']", 'null': 'True', 'related_name': "'+'"}),
            ...
            'vaccination_capacity': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'to': "orm['ScenarioCreator.RelationalFunction']", 'null': 'True', 'related_name': "'+'"}),
        ...
        'ScenarioCreator.controlprotocol': {
            ...
            'cost_of_carcass_disposal_per_animal': ('django_extras.db.models.fields.MoneyField', [], {'decimal_places': '4', 'default': '0.0', 'max_digits': '20'}),
            'cost_of_destruction_appraisal_per_unit': ('django_extras.db.models.fields.MoneyField', [], {'decimal_places': '4', 'default': '0.0', 'max_digits': '20'}),
            'cost_of_destruction_cleaning_per_unit': ('django_extras.db.models.fields.MoneyField', [], {'decimal_places': '4', 'default': '0.0', 'max_digits': '20'}),
            'cost_of_euthanasia_per_animal': ('django_extras.db.models.fields.MoneyField', [], {'decimal_places': '4', 'default': '0.0', 'max_digits': '20'}),
            'cost_of_indemnification_per_animal': ('django_extras.db.models.fields.MoneyField', [], {'decimal_places': '4', 'default': '0.0', 'max_digits': '20'}),
            'cost_of_vaccination_additional_per_animal': ('django_extras.db.models.fields.MoneyField', [], {'decimal_places': '4', 'default': '0.0', 'max_digits': '20'}),
            'cost_of_vaccination_baseline_per_animal': ('django_extras.db.models.fields.MoneyField', [], {'decimal_places': '4', 'default': '0.0', 'max_digits': '20'}),
            'cost_of_vaccination_setup_per_unit': ('django_extras.db.models.fields.MoneyField', [], {'decimal_places': '4', 'default': '0.0', 'max_digits': '20'}),
            ...
            'destruction_priority': ('django.db.models.fields.PositiveIntegerField', [], {'default': '5', 'blank': 'True', 'null': 'True'}),
            ...
            'detection_probability_for_observed_time_in_clinical': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'to': "orm['ScenarioCreator.RelationalFunction']", 'null': 'True', 'related_name': "'+'"}),
            'detection_probability_report_vs_first_detection': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'to': "orm['ScenarioCreator.RelationalFunction']", 'null': 'True', 'related_name': "'+'"}),
            ...
            'name': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'test_delay': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'to': "orm['ScenarioCreator.ProbabilityFunction']", 'null': 'True', 'related_name': "'+'"}),
            ...
            'trace_result_delay': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'to': "orm['ScenarioCreator.ProbabilityFunction']", 'null': 'True', 'related_name': "'+'"}),
            ...
            'vaccination_priority': ('django.db.models.fields.PositiveIntegerField', [], {'default': '5', 'blank': 'True', 'null': 'True'}),
            'vaccination_ring_radius': ('django.db.models.fields.FloatField', [], {'blank': 'True', 'null': 'True'}),
            'vaccine_immune_period': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'to': "orm['ScenarioCreator.ProbabilityFunction']", 'null': 'True', 'related_name': "'+'"})
        },
        ...
        'ScenarioCreator.diseaseprogression': {
            ...
            'disease_prevalence': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'to': "orm['ScenarioCreator.RelationalFunction']", 'null': 'True', 'related_name': "'+'"}),
        ...
        'ScenarioCreator.diseaseprogressionassignment': {
            ...
            'progression': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'to': "orm['ScenarioCreator.DiseaseProgression']", 'null': 'True'})
        },
        ...
        'ScenarioCreator.probabilityfunction': {
            ...
            'graph': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'to': "orm['ScenarioCreator.RelationalFunction']", 'null': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'ScenarioCreator.productiontypepairtransmission': {
            ...
            'airborne_spread': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'to': "orm['ScenarioCreator.AirborneSpread']", 'null': 'True', 'related_name': "'airborne_spread_pair'"}),
            ...
            'direct_contact_spread': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'to': "orm['ScenarioCreator.DirectSpread']", 'null': 'True', 'related_name': "'direct_spread_pair'"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'indirect_contact_spread': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'to': "orm['ScenarioCreator.IndirectSpread']", 'null': 'True', 'related_name': "'indirect_spread_pair'"}),
        ...
        'ScenarioCreator.protocolassignment': {
            ...
            'control_protocol': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'to': "orm['ScenarioCreator.ControlProtocol']", 'null': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'ScenarioCreator.zoneeffectonproductiontype': {
            ...
            'cost_of_surveillance_per_animal_day': ('django_extras.db.models.fields.MoneyField', [], {'decimal_places': '4', 'default': '0.0', 'max_digits': '20'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'production_type': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['ScenarioCreator.ProductionType']"}),
            ...
            'zone_direct_movement': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'to': "orm['ScenarioCreator.RelationalFunction']", 'null': 'True', 'related_name': "'+'"}),
            'zone_indirect_movement': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'to': "orm['ScenarioCreator.RelationalFunction']", 'null': 'True', 'related_name': "'+'"})
        }
    }
