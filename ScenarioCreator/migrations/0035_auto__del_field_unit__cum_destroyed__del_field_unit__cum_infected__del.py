...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.rename_column('ScenarioCreator_unit', 'user_defined_1', 'user_notes')

        # Deleting field 'Unit._cum_destroyed'
        db.delete_column('ScenarioCreator_unit', '_cum_destroyed')

        # Deleting field 'Unit._cum_infected'
        db.delete_column('ScenarioCreator_unit', '_cum_infected')

        # Deleting field 'Unit._final_state_code'
        db.delete_column('ScenarioCreator_unit', '_final_state_code')

        # Deleting field 'Unit._final_control_state_code'
        db.delete_column('ScenarioCreator_unit', '_final_control_state_code')

        # Deleting field 'Unit._cum_detected'
        db.delete_column('ScenarioCreator_unit', '_cum_detected')

        # Deleting field 'Unit._final_detection_state_code'
        db.delete_column('ScenarioCreator_unit', '_final_detection_state_code')

        # Deleting field 'Unit.user_defined_3'
        db.delete_column('ScenarioCreator_unit', 'user_defined_3')

        # Deleting field 'Unit.user_defined_4'
        db.delete_column('ScenarioCreator_unit', 'user_defined_4')

        # Deleting field 'Unit._cum_vaccinated'
        db.delete_column('ScenarioCreator_unit', '_cum_vaccinated')

        # Deleting field 'Unit.user_defined_2'
        db.delete_column('ScenarioCreator_unit', 'user_defined_2')



    def backwards(self, orm):
        db.rename_column('ScenarioCreator_unit', 'user_notes', 'user_defined_1')

        # Adding field 'Unit._cum_destroyed'
        db.add_column('ScenarioCreator_unit', '_cum_destroyed',
                      self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Unit._cum_infected'
        db.add_column('ScenarioCreator_unit', '_cum_infected',
                      self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Unit._final_state_code'
        db.add_column('ScenarioCreator_unit', '_final_state_code',
                      self.gf('django.db.models.fields.CharField')(blank=True, default='', max_length=255),
                      keep_default=False)

        # Adding field 'Unit._final_control_state_code'
        db.add_column('ScenarioCreator_unit', '_final_control_state_code',
                      self.gf('django.db.models.fields.CharField')(blank=True, default='', max_length=255),
                      keep_default=False)

        # Adding field 'Unit._cum_detected'
        db.add_column('ScenarioCreator_unit', '_cum_detected',
                      self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Unit._final_detection_state_code'
        db.add_column('ScenarioCreator_unit', '_final_detection_state_code',
                      self.gf('django.db.models.fields.CharField')(blank=True, default='', max_length=255),
                      keep_default=False)

        # Adding field 'Unit.user_defined_3'
        db.add_column('ScenarioCreator_unit', 'user_defined_3',
                      self.gf('django.db.models.fields.TextField')(blank=True, default=''),
                      keep_default=False)

        # Adding field 'Unit.user_defined_4'
        db.add_column('ScenarioCreator_unit', 'user_defined_4',
                      self.gf('django.db.models.fields.TextField')(blank=True, default=''),
                      keep_default=False)

        # Adding field 'Unit._cum_vaccinated'
        db.add_column('ScenarioCreator_unit', '_cum_vaccinated',
                      self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Unit.user_defined_2'
        db.add_column('ScenarioCreator_unit', 'user_defined_2',
                      self.gf('django.db.models.fields.TextField')(blank=True, default=''),
                      keep_default=False)
    ...
    models = {
        'ScenarioCreator.airbornespread': {
            ...
            'transport_delay': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'+'", 'null': 'True', 'to': "orm['ScenarioCreator.ProbabilityFunction']", 'blank': 'True'}),
        ...
        'ScenarioCreator.controlprotocol': {
            ...
            'name': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'test_delay': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'+'", 'null': 'True', 'to': "orm['ScenarioCreator.ProbabilityFunction']", 'blank': 'True'}),
        ...
        'ScenarioCreator.productiontypepairtransmission': {
            ...
            'airborne_spread': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'airborne_spread_pair'", 'null': 'True', 'to': "orm['ScenarioCreator.AirborneSpread']", 'blank': 'True'}),
            ...
            'direct_contact_spread': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'direct_spread_pair'", 'null': 'True', 'to': "orm['ScenarioCreator.DirectSpread']", 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'indirect_contact_spread': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'indirect_spread_pair'", 'null': 'True', 'to': "orm['ScenarioCreator.IndirectSpread']", 'blank': 'True'}),
