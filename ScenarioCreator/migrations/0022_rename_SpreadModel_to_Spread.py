...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.rename_table('ScenarioCreator_directspreadmodel', 'ScenarioCreator_directspread')
        db.rename_table('ScenarioCreator_indirectspreadmodel', 'ScenarioCreator_indirectspread')
        db.rename_table('ScenarioCreator_airbornespreadmodel', 'ScenarioCreator_airbornespread')

        db.alter_column('ScenarioCreator_productiontypepairtransmission', 'direct_contact_spread_model_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['ScenarioCreator.DirectSpread'], null=True))
        db.alter_column('ScenarioCreator_productiontypepairtransmission', 'indirect_contact_spread_model_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['ScenarioCreator.IndirectSpread'], null=True))
        db.alter_column('ScenarioCreator_productiontypepairtransmission', 'airborne_contact_spread_model_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['ScenarioCreator.AirborneSpread'], null=True))

    def backwards(self, orm):
        db.rename_table('ScenarioCreator_directspread', 'ScenarioCreator_directspreadmodel')
        db.rename_table('ScenarioCreator_indirectspread', 'ScenarioCreator_indirectspreadmodel')
        db.rename_table('ScenarioCreator_airbornespread', 'ScenarioCreator_airbornespreadmodel')

        db.alter_column('ScenarioCreator_productiontypepairtransmission', 'direct_contact_spread_model_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['ScenarioCreator.DirectSpreadModel'], null=True))
        db.alter_column('ScenarioCreator_productiontypepairtransmission', 'indirect_contact_spread_model_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['ScenarioCreator.IndirectSpreadModel'], null=True))
        db.alter_column('ScenarioCreator_productiontypepairtransmission', 'airborne_contact_spread_model_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['ScenarioCreator.AirborneSpreadModel'], null=True))
    ...
    models = {
        ...
        'ScenarioCreator.controlmasterplan': {
            ...
            'destruction_capacity': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'+'", 'blank': 'True', 'to': "orm['ScenarioCreator.RelationalFunction']", 'null': 'True'}),
            ...
            'vaccination_capacity': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'+'", 'blank': 'True', 'to': "orm['ScenarioCreator.RelationalFunction']", 'null': 'True'}),
        ...
        'ScenarioCreator.controlprotocol': {
            ...
            'detection_probability_for_observed_time_in_clinical': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'+'", 'blank': 'True', 'to': "orm['ScenarioCreator.RelationalFunction']", 'null': 'True'}),
            'detection_probability_report_vs_first_detection': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'+'", 'blank': 'True', 'to': "orm['ScenarioCreator.RelationalFunction']", 'null': 'True'}),
        ...
        'ScenarioCreator.diseaseprogression': {
            ...
            'disease_prevalence': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'+'", 'blank': 'True', 'to': "orm['ScenarioCreator.RelationalFunction']", 'null': 'True'}),
        ...
        'ScenarioCreator.outputsettings': {
            ...
            'daily_states_filename': ('django.db.models.fields.CharField', [], {'blank': 'True', 'null': 'True', 'max_length': '255'}),
            ...
            'map_directory': ('django.db.models.fields.CharField', [], {'blank': 'True', 'null': 'True', 'max_length': '255'}),
        ...
        'ScenarioCreator.productiontypepairtransmission': {
            ...
            'airborne_contact_spread_model': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'airborne_spread_pair'", 'blank': 'True', 'to': "orm['ScenarioCreator.AirborneSpread']", 'null': 'True'}),
            ...
            'direct_contact_spread_model': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'direct_spread_pair'", 'blank': 'True', 'to': "orm['ScenarioCreator.DirectSpread']", 'null': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'indirect_contact_spread_model': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'indirect_spread_pair'", 'blank': 'True', 'to': "orm['ScenarioCreator.IndirectSpread']", 'null': 'True'}),
        ...
        'ScenarioCreator.zoneeffectonproductiontype': {
            ...
            'zone_direct_movement': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'+'", 'blank': 'True', 'to': "orm['ScenarioCreator.RelationalFunction']", 'null': 'True'}),
            'zone_indirect_movement': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'+'", 'blank': 'True', 'to': "orm['ScenarioCreator.RelationalFunction']", 'null': 'True'})
        }
    }
