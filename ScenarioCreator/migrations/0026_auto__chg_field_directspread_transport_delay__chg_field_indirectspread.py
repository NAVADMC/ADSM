...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.alter_column('ScenarioCreator_directspread', 'transport_delay_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['ScenarioCreator.ProbabilityFunction']))
        db.alter_column('ScenarioCreator_indirectspread', 'transport_delay_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['ScenarioCreator.ProbabilityFunction']))
        db.alter_column('ScenarioCreator_airbornespread', 'transport_delay_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['ScenarioCreator.ProbabilityFunction']))

    def backwards(self, orm):
        raise RuntimeError("Cannot reverse this migration. 'DirectSpread.transport_delay' and its values cannot be restored.")
        raise RuntimeError("Cannot reverse this migration. 'IndirectSpread.transport_delay' and its values cannot be restored.")
        raise RuntimeError("Cannot reverse this migration. 'AirborneSpread.transport_delay' and its values cannot be restored.")
    ...
    models = {
        'ScenarioCreator.airbornespread': {
            ...
            'transport_delay': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'+'", 'null': 'True', 'blank': 'True', 'to': "orm['ScenarioCreator.ProbabilityFunction']"}),
        ...
        'ScenarioCreator.controlprotocol': {
            ...
            'name': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'test_delay': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'+'", 'null': 'True', 'blank': 'True', 'to': "orm['ScenarioCreator.ProbabilityFunction']"}),
        ...
        'ScenarioCreator.productiontypepairtransmission': {
            ...
            'airborne_spread': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'airborne_spread_pair'", 'null': 'True', 'blank': 'True', 'to': "orm['ScenarioCreator.AirborneSpread']"}),
            ...
            'direct_contact_spread': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'direct_spread_pair'", 'null': 'True', 'blank': 'True', 'to': "orm['ScenarioCreator.DirectSpread']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'indirect_contact_spread': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'indirect_spread_pair'", 'null': 'True', 'blank': 'True', 'to': "orm['ScenarioCreator.IndirectSpread']"}),
        ...
        'ScenarioCreator.scenario': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'language': ('django.db.models.fields.CharField', [], {'default': "'en'", 'blank': 'True', 'max_length': '255'}),
