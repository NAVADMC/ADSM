...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('ScenarioCreator_outputsettings', 'iterations', self.gf('django.db.models.fields.PositiveIntegerField')())
    ...
    models = {
        'ScenarioCreator.airbornespread': {
            ...
            'transport_delay': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'+'", 'to': "orm['ScenarioCreator.ProbabilityFunction']", 'null': 'True'}),
        ...
        'ScenarioCreator.controlmasterplan': {
            ...
            'destruction_capacity': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'+'", 'to': "orm['ScenarioCreator.RelationalFunction']", 'null': 'True'}),
            ...
            'vaccination_capacity': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'+'", 'to': "orm['ScenarioCreator.RelationalFunction']", 'null': 'True'}),
        ...
        'ScenarioCreator.controlprotocol': {
            ...
            'detection_probability_for_observed_time_in_clinical': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'+'", 'to': "orm['ScenarioCreator.RelationalFunction']", 'null': 'True'}),
            'detection_probability_report_vs_first_detection': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'+'", 'to': "orm['ScenarioCreator.RelationalFunction']", 'null': 'True'}),
            ...
            'name': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'test_delay': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'+'", 'to': "orm['ScenarioCreator.ProbabilityFunction']", 'null': 'True'}),
            ...
            'trace_result_delay': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'+'", 'to': "orm['ScenarioCreator.ProbabilityFunction']", 'null': 'True'}),
            ...
            'vaccine_immune_period': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'+'", 'to': "orm['ScenarioCreator.ProbabilityFunction']", 'null': 'True'})
        },
        ...
        'ScenarioCreator.diseaseprogression': {
            ...
            'disease_prevalence': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'+'", 'to': "orm['ScenarioCreator.RelationalFunction']", 'null': 'True'}),
        ...
        'ScenarioCreator.productiontypepairtransmission': {
            ...
            'airborne_spread': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'airborne_spread_pair'", 'to': "orm['ScenarioCreator.AirborneSpread']", 'null': 'True'}),
            ...
            'direct_contact_spread': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'direct_spread_pair'", 'to': "orm['ScenarioCreator.DirectSpread']", 'null': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'indirect_contact_spread': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'indirect_spread_pair'", 'to': "orm['ScenarioCreator.IndirectSpread']", 'null': 'True'}),
        ...
        'ScenarioCreator.zoneeffectonproductiontype': {
            ...
            'zone_direct_movement': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'+'", 'to': "orm['ScenarioCreator.RelationalFunction']", 'null': 'True'}),
            'zone_indirect_movement': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'+'", 'to': "orm['ScenarioCreator.RelationalFunction']", 'null': 'True'})
        }
    }
