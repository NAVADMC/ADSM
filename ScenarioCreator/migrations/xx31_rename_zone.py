...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.rename_column('ScenarioCreator_zone', 'zone_radius', 'radius')
        db.rename_column('ScenarioCreator_zone', 'zone_description', 'name')


    def backwards(self, orm):
        db.rename_column('ScenarioCreator_zone', 'radius', 'zone_radius')
        db.rename_column('ScenarioCreator_zone', 'name', 'zone_description')
    ...
    models = {
        'ScenarioCreator.airbornespread': {
            ...
            'transport_delay': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'+'", 'blank': 'True', 'to': "orm['ScenarioCreator.ProbabilityFunction']", 'null': 'True'}),
        ...
        'ScenarioCreator.controlprotocol': {
            ...
            'name': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'test_delay': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'+'", 'blank': 'True', 'to': "orm['ScenarioCreator.ProbabilityFunction']", 'null': 'True'}),
        ...
        'ScenarioCreator.outputsettings': {
            ...
            'maximum_iterations_for_daily_output': ('django.db.models.fields.PositiveIntegerField', [], {'default': '3', 'blank': 'True', 'null': 'True'}),
        ...
        'ScenarioCreator.productiontypepairtransmission': {
            ...
            'airborne_spread': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'airborne_spread_pair'", 'blank': 'True', 'to': "orm['ScenarioCreator.AirborneSpread']", 'null': 'True'}),
            ...
            'direct_contact_spread': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'direct_spread_pair'", 'blank': 'True', 'to': "orm['ScenarioCreator.DirectSpread']", 'null': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'indirect_contact_spread': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'indirect_spread_pair'", 'blank': 'True', 'to': "orm['ScenarioCreator.IndirectSpread']", 'null': 'True'}),
