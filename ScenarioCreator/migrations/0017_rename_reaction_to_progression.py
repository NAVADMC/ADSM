...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.rename_table('ScenarioCreator_diseasereaction', 'ScenarioCreator_diseaseprogression')
        db.rename_table('ScenarioCreator_diseasereactionassignment', 'ScenarioCreator_diseaseprogressionassignment')

        db.rename_column('ScenarioCreator_diseaseprogressionassignment', 'reaction', 'progression')



    def backwards(self, orm):
        raise ValueError("This is not meant to be backwards compatible.")
        db.rename_table('ScenarioCreator_diseaseprogression', 'ScenarioCreator_diseasereaction')
        db.rename_table('ScenarioCreator_diseaseprogressionassignment', 'ScenarioCreator_diseasereactionassignment')
    ...
    models = {
        ...
        'ScenarioCreator.productiontypepairtransmission': {
            ...
            'airborne_contact_spread_model': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['ScenarioCreator.AirborneSpreadModel']", 'blank': 'True', 'related_name': "'airborne_spread_pair'", 'null': 'True'}),
            ...
            'direct_contact_spread_model': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['ScenarioCreator.DirectSpreadModel']", 'blank': 'True', 'related_name': "'direct_spread_pair'", 'null': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'indirect_contact_spread_model': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['ScenarioCreator.IndirectSpreadModel']", 'blank': 'True', 'related_name': "'indirect_spread_pair'", 'null': 'True'}),
