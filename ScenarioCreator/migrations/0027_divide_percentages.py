...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        for entry in orm.ControlProtocol.objects.all():
            if entry.direct_trace_success_rate > 1.0:
                entry.direct_trace_success_rate /= 100
            if entry.indirect_trace_success > 1.0:
                entry.indirect_trace_success /= 100
            entry.save()

        for entry in orm.IndirectSpread.objects.all():
            if entry.infection_probability > 1.0:
                entry.infection_probability /= 100
            entry.save()

        for entry in orm.DirectSpread.objects.all():
            if entry.infection_probability > 1.0:
                entry.infection_probability /= 100
            entry.save()

        for entry in orm.AirborneSpread.objects.all():
            if entry.spread_1km_probability > 1.0:
                entry.spread_1km_probability /= 100
            entry.save()
    ...
    models = {
        'ScenarioCreator.airbornespread': {
            ...
            'transport_delay': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'+'", 'null': 'True', 'to': "orm['ScenarioCreator.ProbabilityFunction']"}),
        ...
        'ScenarioCreator.controlprotocol': {
            ...
            'name': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'test_delay': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'+'", 'null': 'True', 'to': "orm['ScenarioCreator.ProbabilityFunction']"}),
        ...
        'ScenarioCreator.productiontypepairtransmission': {
            ...
            'airborne_spread': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'airborne_spread_pair'", 'null': 'True', 'to': "orm['ScenarioCreator.AirborneSpread']"}),
            ...
            'direct_contact_spread': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'direct_spread_pair'", 'null': 'True', 'to': "orm['ScenarioCreator.DirectSpread']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'indirect_contact_spread': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'indirect_spread_pair'", 'null': 'True', 'to': "orm['ScenarioCreator.IndirectSpread']"}),
