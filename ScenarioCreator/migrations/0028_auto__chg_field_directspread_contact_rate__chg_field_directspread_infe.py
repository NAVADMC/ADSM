...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.alter_column('ScenarioCreator_airbornespread', 'name',
                        self.gf('django.db.models.fields.CharField')(max_length=255, default='Spread'))
        db.alter_column('ScenarioCreator_indirectspread', 'name',
                        self.gf('django.db.models.fields.CharField')(max_length=255, default='Spread'))
        db.alter_column('ScenarioCreator_directspread', 'name',
                        self.gf('django.db.models.fields.CharField')(max_length=255, default='Spread'))

        # Changing field 'DirectSpread.contact_rate'
        db.alter_column('ScenarioCreator_directspread', 'contact_rate', self.gf('django.db.models.fields.FloatField')(default=0.1))

        # Changing field 'DirectSpread.infection_probability'
        db.alter_column('ScenarioCreator_directspread', 'infection_probability', self.gf('ScenarioCreator.custom_fields.PercentField')(default=1.0))

        # Changing field 'IndirectSpread.infection_probability'
        db.alter_column('ScenarioCreator_indirectspread', 'infection_probability', self.gf('ScenarioCreator.custom_fields.PercentField')(default=1.0))

        # Changing field 'IndirectSpread.contact_rate'
        db.alter_column('ScenarioCreator_indirectspread', 'contact_rate', self.gf('django.db.models.fields.FloatField')(default=0.1))

        # Changing field 'AirborneSpread.spread_1km_probability'
        db.alter_column('ScenarioCreator_airbornespread', 'spread_1km_probability', self.gf('ScenarioCreator.custom_fields.PercentField')(default=1.0))

        # Changing field 'ControlProtocol.indirect_trace_success'
        db.alter_column('ScenarioCreator_controlprotocol', 'indirect_trace_success', self.gf('ScenarioCreator.custom_fields.PercentField')(null=True))

        # Changing field 'ControlProtocol.direct_trace_success_rate'
        db.alter_column('ScenarioCreator_controlprotocol', 'direct_trace_success_rate', self.gf('ScenarioCreator.custom_fields.PercentField')(null=True))

    def backwards(self, orm):

        # Changing field 'DirectSpread.contact_rate'
        db.alter_column('ScenarioCreator_directspread', 'contact_rate', self.gf('django.db.models.fields.FloatField')(null=True))

        # Changing field 'DirectSpread.infection_probability'
        db.alter_column('ScenarioCreator_directspread', 'infection_probability', self.gf('django_extras.db.models.fields.PercentField')(null=True))

        # Changing field 'IndirectSpread.infection_probability'
        db.alter_column('ScenarioCreator_indirectspread', 'infection_probability', self.gf('django_extras.db.models.fields.PercentField')(null=True))

        # Changing field 'IndirectSpread.contact_rate'
        db.alter_column('ScenarioCreator_indirectspread', 'contact_rate', self.gf('django.db.models.fields.FloatField')(null=True))

        # Changing field 'AirborneSpread.spread_1km_probability'
        db.alter_column('ScenarioCreator_airbornespread', 'spread_1km_probability', self.gf('django_extras.db.models.fields.PercentField')(null=True))

        # Changing field 'ControlProtocol.indirect_trace_success'
        db.alter_column('ScenarioCreator_controlprotocol', 'indirect_trace_success', self.gf('django_extras.db.models.fields.PercentField')(null=True))

        # Changing field 'ControlProtocol.direct_trace_success_rate'
        db.alter_column('ScenarioCreator_controlprotocol', 'direct_trace_success_rate', self.gf('django_extras.db.models.fields.PercentField')(null=True))
    ...
    models = {
        ...
        'ScenarioCreator.controlprotocol': {
            ...
            'vaccinate_retrospective_days': ('django.db.models.fields.PositiveIntegerField', [], {'blank': 'True', 'null': 'True'}),
        ...
        'ScenarioCreator.outputsettings': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'iterations': ('django.db.models.fields.PositiveIntegerField', [], {'blank': 'True', 'null': 'True'}),
