...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.rename_column('ScenarioCreator_outputsettings', 'early_stop_criteria', 'stop_criteria')


    def backwards(self, orm):
        db.rename_column('ScenarioCreator_outputsettings', 'stop_criteria', 'early_stop_criteria')
