...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ControlProtocol.use_exams'
        db.add_column('ScenarioCreator_controlprotocol', 'use_exams',
        ...
        # Adding field 'Disease.include_direct_contact_spread'
        db.add_column('ScenarioCreator_disease', 'include_direct_contact_spread',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'Disease.include_indirect_contact_spread'
        db.add_column('ScenarioCreator_disease', 'include_indirect_contact_spread',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ControlProtocol.use_exams'
        db.delete_column('ScenarioCreator_controlprotocol', 'use_exams')
        ...
        # Deleting field 'Disease.include_direct_contact_spread'
        db.delete_column('ScenarioCreator_disease', 'include_direct_contact_spread')

        # Deleting field 'Disease.include_indirect_contact_spread'
        db.delete_column('ScenarioCreator_disease', 'include_indirect_contact_spread')
