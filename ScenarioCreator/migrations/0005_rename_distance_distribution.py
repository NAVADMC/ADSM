...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.rename_column('ScenarioCreator_directspreadmodel', 'distance_id', 'distance_distribution_id')
        db.rename_column('ScenarioCreator_indirectspreadmodel', 'distance_id', 'distance_distribution_id')


    def backwards(self, orm):
        raise RuntimeError("Cannot reverse this migration. 'DirectSpreadModel.distance' and its values cannot be restored.")
    ...
    models = {
        ...
        'ScenarioCreator.controlmasterplan': {
            ...
            'destruction_capacity': ('django.db.models.fields.related.ForeignKey', [], {'null': 'True', 'blank': 'True', 'to': "orm['ScenarioCreator.RelationalFunction']", 'related_name': "'+'"}),
            ...
            'vaccination_capacity': ('django.db.models.fields.related.ForeignKey', [], {'null': 'True', 'blank': 'True', 'to': "orm['ScenarioCreator.RelationalFunction']", 'related_name': "'+'"}),
        ...
        'ScenarioCreator.controlprotocol': {
            ...
            'detection_probability_for_observed_time_in_clinical': ('django.db.models.fields.related.ForeignKey', [], {'null': 'True', 'blank': 'True', 'to': "orm['ScenarioCreator.RelationalFunction']", 'related_name': "'+'"}),
            'detection_probability_report_vs_first_detection': ('django.db.models.fields.related.ForeignKey', [], {'null': 'True', 'blank': 'True', 'to': "orm['ScenarioCreator.RelationalFunction']", 'related_name': "'+'"}),
            ...
            'trace_result_delay': ('django.db.models.fields.related.ForeignKey', [], {'null': 'True', 'blank': 'True', 'to': "orm['ScenarioCreator.ProbabilityFunction']", 'related_name': "'+'"}),
            ...
            'vaccine_immune_period': ('django.db.models.fields.related.ForeignKey', [], {'null': 'True', 'blank': 'True', 'to': "orm['ScenarioCreator.ProbabilityFunction']", 'related_name': "'+'"})
        },
        ...
        'ScenarioCreator.diseasereaction': {
            ...
            'disease_prevalence': ('django.db.models.fields.related.ForeignKey', [], {'null': 'True', 'blank': 'True', 'to': "orm['ScenarioCreator.RelationalFunction']", 'related_name': "'+'"}),
        ...
        'ScenarioCreator.productiontypepairtransmission': {
            ...
            'airborne_contact_spread_model': ('django.db.models.fields.related.ForeignKey', [], {'null': 'True', 'blank': 'True', 'to': "orm['ScenarioCreator.AirborneSpreadModel']", 'related_name': "'airborne_spread_pair'"}),
            ...
            'direct_contact_spread_model': ('django.db.models.fields.related.ForeignKey', [], {'null': 'True', 'blank': 'True', 'to': "orm['ScenarioCreator.DirectSpreadModel']", 'related_name': "'direct_spread_pair'"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'indirect_contact_spread_model': ('django.db.models.fields.related.ForeignKey', [], {'null': 'True', 'blank': 'True', 'to': "orm['ScenarioCreator.IndirectSpreadModel']", 'related_name': "'indirect_spread_pair'"}),
        ...
        'ScenarioCreator.zoneeffectonproductiontype': {
            ...
            'zone_direct_movement': ('django.db.models.fields.related.ForeignKey', [], {'null': 'True', 'blank': 'True', 'to': "orm['ScenarioCreator.RelationalFunction']", 'related_name': "'+'"}),
            'zone_indirect_movement': ('django.db.models.fields.related.ForeignKey', [], {'null': 'True', 'blank': 'True', 'to': "orm['ScenarioCreator.RelationalFunction']", 'related_name': "'+'"})
        }
    }
