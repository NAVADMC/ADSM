...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'ProtocolAssignment', fields ['production_type']
        db.create_unique('ScenarioCreator_protocolassignment', ['production_type_id'])

        # Adding unique constraint on 'ProductionTypePairTransmission', fields ['source_production_type', 'destination_production_type']
        db.create_unique('ScenarioCreator_productiontypepairtransmission', ['source_production_type_id', 'destination_production_type_id'])

        # Adding unique constraint on 'DiseaseReactionAssignment', fields ['production_type']
        db.create_unique('ScenarioCreator_diseasereactionassignment', ['production_type_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'DiseaseReactionAssignment', fields ['production_type']
        db.delete_unique('ScenarioCreator_diseasereactionassignment', ['production_type_id'])

        # Removing unique constraint on 'ProductionTypePairTransmission', fields ['source_production_type', 'destination_production_type']
        db.delete_unique('ScenarioCreator_productiontypepairtransmission', ['source_production_type_id', 'destination_production_type_id'])

        # Removing unique constraint on 'ProtocolAssignment', fields ['production_type']
        db.delete_unique('ScenarioCreator_protocolassignment', ['production_type_id'])
    ...
    models = {
        ...
        'ScenarioCreator.controlmasterplan': {
            ...
            'destruction_capacity': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['ScenarioCreator.RelationalFunction']", 'related_name': "'+'", 'null': 'True', 'blank': 'True'}),
            ...
            'vaccination_capacity': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['ScenarioCreator.RelationalFunction']", 'related_name': "'+'", 'null': 'True', 'blank': 'True'}),
        ...
        'ScenarioCreator.controlprotocol': {
            ...
            'destruction_priority': ('django.db.models.fields.IntegerField', [], {'default': '5', 'null': 'True', 'blank': 'True'}),
            ...
            'detection_probability_for_observed_time_in_clinical': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['ScenarioCreator.RelationalFunction']", 'related_name': "'+'", 'null': 'True', 'blank': 'True'}),
            'detection_probability_report_vs_first_detection': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['ScenarioCreator.RelationalFunction']", 'related_name': "'+'", 'null': 'True', 'blank': 'True'}),
            ...
            'trace_result_delay': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['ScenarioCreator.ProbabilityFunction']", 'related_name': "'+'", 'null': 'True', 'blank': 'True'}),
            ...
            'vaccination_priority': ('django.db.models.fields.IntegerField', [], {'default': '5', 'null': 'True', 'blank': 'True'}),
            'vaccination_ring_radius': ('django.db.models.fields.FloatField', [], {'null': 'True', 'blank': 'True'}),
            'vaccine_immune_period': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['ScenarioCreator.ProbabilityFunction']", 'related_name': "'+'", 'null': 'True', 'blank': 'True'})
        },
        ...
        'ScenarioCreator.diseasereaction': {
            ...
            'disease_prevalence': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['ScenarioCreator.RelationalFunction']", 'related_name': "'+'", 'null': 'True', 'blank': 'True'}),
        ...
        'ScenarioCreator.outputsettings': {
            ...
            'daily_states_filename': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
            ...
            'map_directory': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
            'maximum_iterations_for_daily_output': ('django.db.models.fields.IntegerField', [], {'default': '3', 'null': 'True', 'blank': 'True'}),
        ...
        'ScenarioCreator.productiontypepairtransmission': {
            ...
            'airborne_contact_spread_model': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['ScenarioCreator.AirborneSpreadModel']", 'related_name': "'airborne_spread_pair'", 'null': 'True', 'blank': 'True'}),
            ...
            'direct_contact_spread_model': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['ScenarioCreator.DirectSpreadModel']", 'related_name': "'direct_spread_pair'", 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'indirect_contact_spread_model': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['ScenarioCreator.IndirectSpreadModel']", 'related_name': "'indirect_spread_pair'", 'null': 'True', 'blank': 'True'}),
        ...
        'ScenarioCreator.zoneeffectonproductiontype': {
            ...
            'zone_direct_movement': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['ScenarioCreator.RelationalFunction']", 'related_name': "'+'", 'null': 'True', 'blank': 'True'}),
            'zone_indirect_movement': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['ScenarioCreator.RelationalFunction']", 'related_name': "'+'", 'null': 'True', 'blank': 'True'})
        }
    }
