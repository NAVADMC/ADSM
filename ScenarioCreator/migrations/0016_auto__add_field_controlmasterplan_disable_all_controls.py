...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ControlMasterPlan.disable_all_controls'
        db.add_column('ScenarioCreator_controlmasterplan', 'disable_all_controls',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ControlMasterPlan.disable_all_controls'
        db.delete_column('ScenarioCreator_controlmasterplan', 'disable_all_controls')
